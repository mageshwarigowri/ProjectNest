...
export function StoreProvider({ children }) {
  ...
  const value = useMemo(() => ({ user, authenticated, cart, setCart, theme, setTheme, addToCart, updateCart, removeFromCart, login, logout, announce }), [user, authenticated, cart, theme])
